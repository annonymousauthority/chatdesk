...
export default function ChatFrame({ agentKey }) {
  ...
  return (
    <div className="mx-auto flex h-[700px] min-h-full w-full max-w-[1200px] items-start justify-center rounded-2xl border lg:w-3/4">
      <div className="hidden h-full w-1/2 flex-col items-start justify-between rounded-tl-2xl bg-gray-200 lg:flex">
