                        ...
                        <button
                          ...
                          className={
                            selectedCategory == 'General'
                              ? 'w-1/4 rounded-lg border border-blue-500 bg-blue-500 p-2 text-black hover:bg-blue-500 text-sm'
                              : 'w-1/4 rounded-lg border bg-blue-100 p-2 text-black hover:bg-blue-400 text-sm font-light'
                          }
                        >
                          General
                        </button>
                        <button
                          ...
                          className={
                            selectedCategory == 'Sales'
                              ? 'w-1/4 rounded-lg border border-blue-500 bg-blue-500 p-2 text-black hover:bg-blue-500 text-sm'
                              : 'w-1/4 rounded-lg border  bg-blue-100 p-2 text-black hover:bg-blue-300 text-sm font-light'
                          }
                        >
                          Sales
                        </button>
